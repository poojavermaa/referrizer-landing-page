...
const stories: Story[] = [
    ...
    },
    {
        ...
        content: "Prior to using Referrizer I was paying over 8 different companies a monthly fee for individual services. I have been able to save over $1,200 a month by streamlining all of my services by just using Referrizer.",
        author: {
            name: "Meteus Felipe",
            role: "Owner at",
    ...
    },
    {
        ...
        content: "Being able to create custom offers that you can email & text to your clients is wonderful! You have so much flexibility in selecting which clients to send the offers to.",
        author: {
            name: "Meteus Felipe",
            role: "Owner at",
            company: "Goosebumps Cryotherapy",
    ...
    return (
        <div className="w-full py-[2%] px-[8%] sm:py-[4%] sm:px-[8%]">
            ...
            <div className="text-center mt-12">
                <button className="text-[#377DFF] font-semibold border-2 border-[#377DFF] px-8 py-3 rounded-lg
